...
public class NoteActivity extends AppCompatActivity {
    public static final String NOTE_POSITION = "com.example.notebook.NOTE_POSITION";
   ...
   private NoteActivityViewModel mViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewModelProvider viewModelProvideer = new ViewModelProvider(getViewModelStore(),
                ViewModelProvider.AndroidViewModelFactory.getInstance(getApplication()));
        mViewModel = viewModelProvideer.get(NoteActivityViewModel.class);
